...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        _textArray=[[NSArray alloc]initWithObjects:@"模拟设备1",@"模拟设备2",@"模拟设备3",nil];
    }
    return self;
}
...
{
    SensorViewController *sensorViewController=[[SensorViewController alloc]init];
